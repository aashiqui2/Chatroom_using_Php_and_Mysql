...
<body>
  ...
  <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      <h1 class="display-4 font-weight-normal">MyAnonymousChat</h1>
      <p class="lead font-weight-normal">Chat with your friends without worrying about the chat logs.Now you can freely chat with Your friends using our free platform.</p>


      
      <form action="claim.php" method="post">
        MyAnonymousChat.com/<input type="text" autocomplete="off" name="room">


        <button class="btn btn-outline-secondary" style="margin-top:6px" href="#">Claim room</button>
      </form>
